...
class FrameFiltroSobel(FrameFiltro.FrameFiltro):
    ...
    def updateValue(self, event):
        ...
        self.principal.img_alterada = Filtros().filtro_sobel(self.principal.img_original, mascara)
        super().updateValue(event)
        
    #----------------------------------------------
    def executa_frame_filtro(self, titulo, dimensao, mascara_ini, mascara_fim, mascara_default):

        self.principal.img_alterada = Filtros().filtro_sobel(self.principal.img_original, mascara_default)
